...
import Subscription from "./Subscription"; // ✅ M-PESA Subscription
...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* 💰 M-PESA Subscription section for users */}
      {!isLoggedIn && <Subscription onSuccess={() => alert("🎉 Subscription successful!")} />}
